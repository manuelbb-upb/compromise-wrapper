...
class MOP():
    ...
    def set_vec_objective(self, func, model_cfg="rbf", dim_out=1, max_func_calls=300, func_iip=False):
        if not self.mop.objectives:
            ...
            jl.C.add_objectives_b(self.mop, objf, cfg, dim_out=dim_out, max_func_calls=max_func_calls, func_iip=func_iip)
        else:
